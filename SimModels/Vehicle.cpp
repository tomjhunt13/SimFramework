...
namespace Models {
    ...
    Vehicle::Vehicle(float dt) : System(dt)
    {
        ...
        this->m_LockupClutch.Configure(this->m_Transmission.OutClutchTorque(), this->m_BrakeTyreSum.OutSignal(), this->m_Controller.OutClutchStiffness());
        this->m_Controller.Configure(this->m_LockupClutch.OutSpeed2(), this->m_InThrottle.OutSignal(), this->m_Transmission.OutGearIndex());
        this->m_Engine.Configure(this->m_Controller.OutAugmentedThrottle(), this->m_Transmission.OutWheelSpeed());
        this->m_Transmission.Configure(this->m_LockupClutch.OutSpeed1(), this->m_Engine.OutEngineTorque());
        ...
        this->m_Tyre.Configure(this->m_LockupClutch.OutSpeed2(), this->m_VehicleDynamics.OutVehicleVelocity());
