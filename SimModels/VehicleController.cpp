...
namespace Models {
    ...
    ClutchController::ClutchController(float engagementSpeed, std::string name) :
            Function(name), m_EngagementSpeed(engagementSpeed) {};
...
//        };
        ...
        {
            return 0.5 + 0.5 * (transmissionSpeed / this->m_EngagementSpeed);
        }
